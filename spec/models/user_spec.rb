...
RSpec.describe User, type: :model do
  ...
  describe 'Validations' do
    ...
    context 'should not allow invalid emails' do
      emails = ['email.com', 'email. @c .com', '@email.com']
    ...
    context 'should allow valid emails' do
      emails = ['linda@example.com', 'linda123@test.ke', 'linda_achieng@email.ke']
    ...
    describe 'Relations' do
      it { is_expected.to have_many(:content) }
    end
  end
end
